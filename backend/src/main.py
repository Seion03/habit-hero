...
from src.habits.routes import router as habits_router
from src.checkins.routes import router as checkins_router
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://frontend:3000","https://habithero.qmarkdesk.com", "http://www.habithero.qmarkdesk.com"],
